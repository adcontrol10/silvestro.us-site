...
In GitHub Settings → Pages, choose Deploy from a branch, then main and /(root). First review the github.io preview. Do not set a custom domain or change DNS until the preview is approved.
